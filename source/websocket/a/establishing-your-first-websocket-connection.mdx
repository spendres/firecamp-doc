...
## Directions
1. Open the Firecamp and navigate to WebSocket client. 

2. Type the endpoint that you want to test in the URL bar. Firecamp by default has the sample endpoint `ws://echo.websocket.org` listed in the `URL` bar.
...
<Zoom>
    <img
        alt="configuring-server"
        src="../assets/configuring-server-endpoint.png"
        width="100%"
    />
</Zoom>
