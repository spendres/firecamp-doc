...
For example, breaking down the URL (Uniform Resource Locator) https://jsonplaceholder.typicode.com/posts?id=11&name=John

The protocol is **https**
The domain name is **jsonplaceholder.typicode.com**
The path to the resource (Path Parameter) is **/posts**
Finally, the query parameters being **id=11&name=John**
