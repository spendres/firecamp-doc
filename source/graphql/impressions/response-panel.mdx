...
Viewing the Response is not limited to only JSON/Text. Response body can be HTML, JSON, XML, Text, Image, GIF. Options like copy, fold and word wrap are also available through the utility icons. That way the GraphQL response body can be viewed, and styled as needed.
