...
title: 01. URL Bar
subtitle:
description: Overview of the URL Bar in the API app
---
...
- **UNLINK** - This `UNLINK` method deletes meta-information about an object. Only headers exactly matching the headers given are removed.

You can make a selection of your desired Request Method from the `Quick Method Selection` section availabe in the body tab of Request Panel.
