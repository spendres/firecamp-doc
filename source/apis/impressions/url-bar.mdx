...
You can make a selection of your desired Request Method from the `Quick Method Selection` section availabe in the body tab of <Link to="apis/impressions/request-panel">**Request Panel**</Link>.
...
![URL Bar with Request Method dropdown open](../assets/url_method.jpg)
...
<!--TODO: Add links to Environment Snippets, Steps to save your request in firecamp & Projects in Firecamp-->
## 4. Save Button
