...
The URL bar consists of five elements:
...
You can make a selection of your desired Request Method from the `Quick Method Selection` section availabe in the body tab of <Link to="./request-panel">**Request Panel**</Link>.
