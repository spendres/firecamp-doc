...
## Request Methods supported in Firecamp API

Firecamp supports several request methods that acts on requests made to the API endpoint. These methods are as follows:
