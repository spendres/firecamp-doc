...
The response panel in the Firecamp API app is to view the information/data sent as part of the response by the server when a request has been made.
...
To view the the response in JSON or text, one can click the toggle buttons below the `Body` tab. Options like copy, fold and word wrap are also available through the utility icons. That way the API response body can be viewed, and styled as needed.
