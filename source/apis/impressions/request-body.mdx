...
![Request Body](../assets/req_body.png)
...
![body selection](../assets/req_bd_sel.png)
...
![new body](../assets/req_new_body.png)
...
The quick method selection of the API app helps you quickly pick and change the request methods associated with your API request. This feature was designed with accessibility in mind to help developers switch through popular methods faster and check the response in real-time. To get the list of all requests methods available in Firecamp, check out the <Link to="./url-bar">URL bar impression</Link>.
