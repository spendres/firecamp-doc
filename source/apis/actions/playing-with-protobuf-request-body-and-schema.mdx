...
Protocol buffer is a method of serializing or encrypteing your data. A protobuf schema can be used to describe the structure of the API request or a query.
